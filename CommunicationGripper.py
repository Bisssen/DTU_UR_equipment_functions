...
from . import config_gripper as cfg
...
class gripperSerial():
    def __init__(self):
        ...
        print('    Equipment found on port ' + ports[0].device)

        self.ser = serial.Serial(port=ports[0].device, baudrate=115200, timeout=1, parity=serial.PARITY_NONE,
    ...
    def readBytes(self, num_bytes):
        return self.ser.read(num_bytes).hex().upper()
