...
class Ros2Actions():
    ...
    def execute_callback(self, goal_handle) -> any:
    ...
    def follow_joints_list(self, goal_handle, joints_list: list[float]) -> None:
    ...
    def check_if_canceled(self, goal_handle) -> bool:
    ...
    def cancel_callback(self, goal_handle) -> None:
        # Stop the arm
